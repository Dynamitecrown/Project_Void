...
template<> SHOOTERCORERUNTIME_API UScriptStruct* StaticStruct<FLyraControlPointStatusMessage>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_Engine_Projects_LyraStarterGame_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Messages_ControlPointStatusMessage_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Engine_Projects_LyraStarterGame_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Messages_ControlPointStatusMessage_h_Statics::ScriptStructInfo[] = {
		{ FLyraControlPointStatusMessage::StaticStruct, Z_Construct_UScriptStruct_FLyraControlPointStatusMessage_Statics::NewStructOps, TEXT("LyraControlPointStatusMessage"), &Z_Registration_Info_UScriptStruct_LyraControlPointStatusMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraControlPointStatusMessage), 3853394381U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Engine_Projects_LyraStarterGame_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Messages_ControlPointStatusMessage_h_34386744(TEXT("/Script/ShooterCoreRuntime"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_Engine_Projects_LyraStarterGame_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Messages_ControlPointStatusMessage_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Engine_Projects_LyraStarterGame_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Messages_ControlPointStatusMessage_h_Statics::ScriptStructInfo),
		nullptr, 0);
